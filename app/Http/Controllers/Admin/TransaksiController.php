...
class TransaksiController extends Controller
{
    ...
    public function filtertransaksi(Request $request)
    {
      ...
      foreach($transaksi as $item) {
        $return .="<tr>
          ...
          $return .="<td><a href='invoice-customer/$item->invoice' class='btn btn-sm btn-light style='color:white'>Invoice</a></td>";
        $return .= "</td>
        </tr>";
        $no++;
      }
    ...
    public function invoice( Request $request)
    {
      ...
      return view('modul_admin.transaksi.invoice', compact('invoice','dataInvoice', 'data_banks'));
    }
}
