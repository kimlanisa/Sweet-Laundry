  ...
  <div class="row">
    ...
    <div class="col-lg-4 col-md-12 col-12">
      ...
      <div class="card card-employee-task">
          <div class="card-header">
              <h4 class="card-title">Pendapatan Karyawan</h4>
              ...
              <div class="employee-task d-flex justify-content-between align-items-center">
                  <div class="media">
                      {{-- <div class="avatar mr-75">
                          <img src="{{asset($user->foto == null ? 'backend/images/profile/user.jpg' : 'storage/images/foto_profile/'. $user->foto)}}" class="rounded" width="42" height="42" alt="Avatar" />
                      </div> --}}
                      <div class="media-body my-auto">
                  ...
                  <div class="d-flex align-items-center">
                      <small class="text-muted mr-75">{{Rupiah::getRupiah($user->transaksi()->sum('harga_akhir'))}}</small>
