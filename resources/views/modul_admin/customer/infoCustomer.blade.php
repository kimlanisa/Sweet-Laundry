...
@section('title','Admin - Detail Data Konsumen')
@section('header','Detail Data Konsumen')
@section('content')
<div class="row">
        ...
        <div class="card-content">
            <div class="row">
              <div class="card-body">
                <div class="card-text">
                    <dl class="row">
                        <dt class="col-sm-4">Nama Konsumen</dt>
                        <dd class="col-sm-4">: {{$customer->name}}</dd>
                    </dl>

                    <dl class="row">
                        <dt class="col-sm-4">Email Konsumen</dt>
                    ...
                    <dl class="row">
                        <dt class="col-sm-4">Alamat Konsumen</dt>
