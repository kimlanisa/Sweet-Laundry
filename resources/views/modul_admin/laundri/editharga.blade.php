    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-interative" data-dismiss="modal">Batal</button>
                <button type="button" class="btn btn-primary float-right" id="simpan_harga">Edit</button>
            </div>
        </div>
    </div>
</div>
