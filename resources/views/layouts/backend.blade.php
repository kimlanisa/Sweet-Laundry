    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                {{-- Menu Admin --}}
                    @if (auth::user()->auth == "Admin")
                        <li class=" nav-item"><a href="#"><i class="feather icon-users"></i><span class="menu-title" data-i18n="User">Management User</span></a>
                            <ul class="menu-content">
                              ...
                              <li class="nav-item {{ (request()->is('customer')) ? 'active' : '' }}">
                                <a href="{{url('customer')}}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="List">Konsumen</span></a>
                              </li>
                            </ul>
                        </li>

                        <li class="nav-item {{ (request()->is('data-harga')) ? 'active' : '' }}">
                            <a href="{{url('data-harga')}}"><i class="feather icon-package"></i><span class="menu-item" data-i18n="List">Jenis Layanan</span></a>
                        </li>

                        <li class="nav-item {{ (request()->is('transaksi')) ? 'active' : '' }}">
                          <a href="{{route('transaksi.index')}}"><i class="feather icon-shopping-cart"></i><span class="menu-item" data-i18n="List">History Transaksi</span></a>
                        </li>

                        <li class="nav-item {{ (request()->is('finance')) ? 'active' : '' }}">
                            <a href="{{route('finance.index')}}"><i class="feather icon-file"></i><span class="menu-item" data-i18n="List">Generate Laporan</span></a>
                        </li>
                    ...
                    @elseif(auth::user()->auth == "Karyawan")
                        <li class="nav-item {{ (request()->is('customers')) ? 'active' : '' }}">
                            <a href="{{url('customers')}}"><i class="feather icon-users"></i><span class="menu-item" data-i18n="List">Data Konsumen</span></a>
                        </li>

                        <li class="nav-item {{ (request()->is('pelayanan')) ? 'active' : '' }}">
                            <a href="{{route('pelayanan.index')}}"><i class="feather icon-shopping-cart"></i><span class="menu-item" data-i18n="List">Transaksi</span></a>
                        </li>
