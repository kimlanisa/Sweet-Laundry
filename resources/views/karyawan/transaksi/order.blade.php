...
<div class="card">
    <div class="card-body">
        <h4 class="card-title">
            <a href="{{url('add-order')}}" class="btn btn-primary">Tambah Transaksi</a>
        </h4>
                        ...
                        <td>
                            ...
                            @elseif($item->status_payment == 'Success')
                              ...
                              @elseif($item->status_order == 'Done')
                                <a class="btn btn-sm btn-success" style="color:white" data-id-update="{{$item->id}}" id="updateStatus">Ambil</a>
                              @elseif($item->status_order == 'Delivery')
                                <a href="{{url('invoice-kar', $item->id)}}" class="btn btn-sm btn-light" style="color:white">Invoice</a>
                              @endif
